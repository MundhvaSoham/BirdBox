...
import logo from "../public/Birdbox.png";
...
const Home: NextPage = () => {
  return (
    <Layout>
      <div className="w-full md:ml-6 md:pr-6 pl-1 flex justify-center">
        <Image
          src={logo}
          width="1000"
          height="200"
      ...
      {/* <div className="border-y-2 border-solid border-black h-20">
        <div className="flex flex-row h-full justify-center">
          <a
            href="https://github.com/carllippert/Birdbox"
            target="_blank"
        ...
        <div className="flex-1 w-full h-full bg-[#ff90e8] border-b-2 lg:border-b-0 border-black border-solid lg:border-r-2">
          <div className="mx-auto my-auto max-w-[40rem] mt-16 lg:px-12 px-4">
            ...
            <div className=" py-6 text-2xl">
              With Birdbox, anyone on planet earth can start earning crypto. Just
